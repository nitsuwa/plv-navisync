...
export const FURNITURE_CATEGORIES: FurnitureCategory[] = [
  {
    ...
    items: [
      ...
      { type: "audience-chair", name: "Audience Chair", width: 11, height: 13, color: "#4b5563", description: "Compact padded chair for presentation seating", keywords: ["evaluation", "panel", "presentation"] },
      { type: "audience-seating-4x4", name: "Audience Seating - 4x4", width: 58, height: 58, color: "#4b5563", description: "Grouped four-by-four presentation seating block", keywords: ["evaluation", "panel", "presentation", "seating block"] },
      { type: "lecture-chair-writing-arm", name: "Lecture Chair with Writing Arm", width: 14, height: 16, color: "#4b5563", description: "Compact lecture chair with attached tablet arm", keywords: ["lecture", "classroom", "tablet arm", "writing"] },
      { type: "lecture-row-4", name: "Lecture Row 4", width: 48, height: 14, color: "#4b5563", description: "Four lecture chairs with writing arms", keywords: ["lecture", "classroom", "row"] },
      { type: "lecture-row-6", name: "Lecture Row 6", width: 70, height: 14, color: "#4b5563", description: "Six lecture chairs with writing arms", keywords: ["lecture", "classroom", "row"] },
      { type: "lecture-row-8", name: "Lecture Row 8", width: 92, height: 14, color: "#4b5563", description: "Eight lecture chairs with writing arms", keywords: ["lecture", "classroom", "row"] },
      { type: "waiting-bench", name: "Waiting Bench", width: 36, height: 11, color: "#665343", description: "Waiting-area bench with back" },
    ],
  },
  {
    id: "tables",
    ...
    items: [
      ...
      { type: "rectangular-table", name: "Rectangular Table", width: 34, height: 20, color: "#8b6f4e", description: "Rotatable generic rectangular table" },
      { type: "round-table-chairs", name: "Round Table + Chairs", width: 48, height: 48, color: "#8b6f4e", description: "Round meeting table with six surrounding chairs" },
      ...
      { type: "boardroom-table-chairs", name: "Boardroom Table + Chairs", width: 112, height: 54, color: "#795548", description: "Long boardroom table with perimeter chairs", keywords: ["boardroom", "conference", "meeting"] },
      { type: "collaborative-hub-table", name: "Collaborative Hub Table", width: 54, height: 48, color: "#8b6f4e", description: "Three-arm collaboration table with surrounding seats", keywords: ["collaboration", "graduate studies", "tri-arm", "hub"] },
      { type: "speech-lab-row", name: "Speech Lab Row", width: 72, height: 20, color: "#64748b", description: "Repeated training desk and station row", keywords: ["speech lab", "training", "desk row", "stations"] },
      { type: "communal-study-table", name: "Long Study Table + Chairs", width: 116, height: 44, color: "#8b6f4e", description: "Long communal study table with chairs on both sides", keywords: ["study", "communal", "reading", "shared table"] },
      { type: "double-sided-study-table", name: "Double-Sided Study Table", width: 70, height: 30, color: "#8b6f4e", description: "Compact study table with continuous benches on both sides", keywords: ["study", "bench", "communal", "double-sided"] },
      { type: "student-desk-chair", name: "Student Desk + Chair", width: 30, height: 24, color: "#7a5c3a", description: "Single compact study workstation", keywords: ["study", "desk", "individual"] },
      { type: "study-table-4", name: "Study Table + 4 Chairs", width: 44, height: 34, color: "#8b6f4e", description: "Four-seat study table" },
      { type: "study-table-6", name: "Study Table + 6 Chairs", width: 54, height: 38, color: "#8b6f4e", description: "Six-seat study table" },
      ...
      { type: "conference-table-large", name: "Conference Table - Large", width: 112, height: 64, color: "#795548", description: "Large polygonal boardroom table with perimeter chairs", keywords: ["boardroom", "polygon", "evaluation"] },
      ...
      { type: "lab-workbench", name: "Laboratory Workbench", width: 52, height: 20, color: "#64748b", description: "Shared laboratory work surface" },
      ...
      { type: "faculty-desk-chair", name: "Faculty Desk + Chair", width: 34, height: 26, color: "#7a5c3a", description: "Faculty office workstation" },
      ...
      { type: "library-study-table", name: "Library Study Table + Chairs", width: 48, height: 30, color: "#8b6f4e", description: "Shared library study table" },
  ...
  },
  {
    ...
    items: [
      ...
      { type: "rack-bookshelf", name: "Rack / Bookshelf", width: 36, height: 10, color: "#6b5b45", description: "Narrow library stack rack with shelf divisions", keywords: ["library", "stacks", "collection", "shelf"] },
      { type: "double-sided-library-shelf", name: "Double-Sided Library Shelf", width: 42, height: 12, color: "#6b5b45", description: "Two-sided library shelving" },
      { type: "tall-storage-cabinet", name: "Tall Storage Cabinet", width: 18, height: 24, color: "#71717a", palette: "advanced" },
      { type: "equipment-cabinet", name: "Equipment Cabinet", width: 24, height: 18, color: "#64748b", description: "Ventilated equipment cabinet" },
      { type: "locker", name: "Locker", width: 30, height: 12, color: "#64748b", description: "Row of individual lockers" },
    ],
  },
  {
    id: "electronics",
    ...
    icon: "Monitor",
    items: [
      { type: "computer-workstation", name: "Computer Workstation", width: 34, height: 26, color: "#475569", description: "Desk with monitor, keyboard, and chair" },
      { type: "computer-workstation-chair", name: "Computer Workstation + Chair", width: 30, height: 24, color: "#475569", description: "Single computer workstation" },
      ...
      { type: "computer-station", name: "Computer Station", width: 32, height: 20, color: "#475569", description: "Compact wall-side computer desk with seat", keywords: ["computer", "terminal", "wall station", "technical"] },
      { type: "projector", name: "Projector", width: 12, height: 10, color: "#64748b", description: "Ceiling-mounted projection unit" },
      { type: "wall-display", name: "Wall Display / TV", width: 24, height: 6, color: "#334155", description: "Wall-mounted display screen" },
      { type: "printer-copier", name: "Printer / Copier", width: 18, height: 16, color: "#64748b", description: "Office printer and copier" },
  ...
  },
  {
    ...
    label: "Food / Service",
    icon: "Store",
    keywords: ["food", "concession"],
    items: [
      { type: "service-stall", name: "Food / Service Stall", width: 48, height: 28, color: "#b7793b", description: "Booth with a visible front service counter", keywords: ["concession", "booth"] },
      { type: "service-counter", name: "Service Counter", width: 54, height: 14, color: "#7a5c3a", description: "Long narrow counter for customer service", keywords: ["counter", "customer service"] },
    ],
  },
  {
    id: "library-study",
    label: "Library / Study",
    icon: "BookOpen",
    keywords: ["library", "study", "circulation", "stacks", "reading"],
    items: [
      { type: "library-counter", name: "Library Counter / Circulation Desk", width: 62, height: 20, color: "#7a5c3a", description: "Formal library checkout and circulation desk", keywords: ["checkout", "front desk", "reference"] },
      { type: "wall-counter", name: "Wall Counter / Study Counter", width: 64, height: 12, color: "#8b6f4e", description: "Slim wall-side study or utility counter", keywords: ["wall desk", "study", "work surface"] },
      { type: "study-carrel", name: "Study Carrel", width: 26, height: 24, color: "#7a5c3a", description: "Semi-private individual study desk with chair", keywords: ["study", "individual", "partition", "library"] },
      { type: "study-carrel-row", name: "Study Carrel Row", width: 76, height: 24, color: "#7a5c3a", description: "Four repeated individual study carrels", keywords: ["study", "row", "library", "stations"] },
    ],
  },
  {
    id: "outdoor-atrium",
    label: "Outdoor / Atrium",
    icon: "Umbrella",
    keywords: ["outdoor", "atrium", "garden", "patio", "shade", "canopy"],
    items: [
      { type: "garden-shade-umbrella", name: "Garden Shade Umbrella", width: 52, height: 52, color: "#b7793b", description: "Large geometric outdoor shade canopy", keywords: ["umbrella", "canopy", "garden", "patio", "outdoor"] },
    ],
  },
  {
    id: "medical",
  ...
  },
  {
    ...
    icon: "Bath",
    keywords: ["bathroom", "washroom", "toilet"],
    items: [
      ...
      { type: "hand-dryer", name: "Hand Dryer", width: 10, height: 8, color: "#64748b", description: "Wall-mounted hand dryer" },
      { type: "restroom-trash-bin", name: "Restroom Trash Bin", width: 10, height: 10, color: "#64748b" },
      { type: "floor-drain", name: "Floor Drain", width: 7, height: 7, color: "#94a3b8", description: "Small floor drainage grate" },
    ],
  },
  {
    id: "safety",
  ...
  },
  {
    ...
    items: [
      ...
      { type: "drinking-fountain", name: "Drinking Fountain", width: 18, height: 12, color: "#38bdf8", description: "Compact wall-side drinking fountain" },
      { type: "reception-counter", name: "Reception / Service Counter", width: 60, height: 18, color: "#7a5c3a", description: "Service counter with workstation cue", keywords: ["front desk", "registrar", "student affairs", "counter"] },
    ],
  },
];
